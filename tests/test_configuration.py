...
class TestConfigurationLoading(unittest.TestCase):
    ...
    def test_config_validation(self):
        ...
        yaml.dump(valid_config, tempfile.NamedTemporaryFile(mode='w', delete=False))
    ...
    def test_config_invalid_mode(self):
        ...
        yaml.dump(invalid_config, tempfile.NamedTemporaryFile(mode='w', delete=False))
...
class TestConfigurationIntegration(unittest.TestCase):
    ...
    def test_component_with_config(self, mock_lpjml_coupler):
        ...
        mock_lpjml_instance.config.coupled_config.lpjml_settings.country_code_to_name = True
        ...
        with patch('pycopanlpjml.component.read_yaml') as mock_read_yaml:
            mock_read_yaml.return_value = _from_yaml(test_config, CoupledConfig)
            ...
            self.assertEqual(component._parallel_executor.config.mode, 'serial')
    ...
    def test_component_with_default_config(self, mock_lpjml_coupler):
        ...
        with patch('pycopanlpjml.component.read_yaml') as mock_read_yaml:
            ...
            mock_read_yaml.side_effect = lambda path, cls: read_yaml(default_config_path, cls)
            ...
            self.assertEqual(component._parallel_executor.config.mode, 'serial')  # Will be serial in test environment
